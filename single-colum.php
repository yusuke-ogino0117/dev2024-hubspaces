...
<?php if( get_field('colum_office_name', 10800) ): ?>
<div class="recommend_office">
  <h2>おすすめのレンタルオフィス</h2>
  <div class="recommend_office_inner">
    <div class="office_img">
      <img src="<?php the_field('colum_office_img', 10800); ?>" alt="">
    </div>
    <div class="office_desc">
      <h3><?php the_field('colum_office_name', 10800); ?></h3>
      <p><?php the_field('colum_office_desc', 10800); ?></p>
      <a href="<?php the_field('colum_office_url', 10800); ?>">詳細はこちら</a>
    </div>
  </div>
</div>
<?php endif; ?>
...
<?php
 ...
 ?>
 <div id="related_post">
  <h2 class="headline rich_font"><?php echo esc_html( $dp_options['related_post_headline'] ); ?></h2>
  <ol class="clearfix">
...
<div class="fix_btn">
  <div class="fix_btn_item">
    <a href="https://hubspaces.jp/"><i class="fas fa-search"></i> オフィスを検索する</a>
  </div>
  <!-- <div class="fix_btn_item">
    <a href="https://hubspaces.jp/prorequest/ "><i class="fas fa-user"></i> 無料でオフィス紹介</a>
  </div> -->
</div>
